					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "APTransportApplication",
									"targetURL": "#apmovements-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"apmovements-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apmovements",
									"url": sap.ui.require.toUrl("apmovements")
								}
							}
						}
					}
